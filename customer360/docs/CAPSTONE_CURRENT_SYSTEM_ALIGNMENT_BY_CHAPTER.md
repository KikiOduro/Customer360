...
- The landing page hero visual should also reflect the actual product rather than a generic stock dashboard image. A product-themed illustration that mirrors Customer360’s real workflow, plain-language group labels, progress tracking, and report/export emphasis is more consistent with the shipped system and the dissertation screenshots.
